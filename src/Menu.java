...
public class Menu {
     ...
     * @throws IOException
     */
    public Menu(String type, ArrayList<String> casillas) throws IOException {
        width = 800;
        height = 500;
    ...
    public static void main(String[] args) throws IOException {
        ...
        casillas = gameData.arraylist();
        Menu menuClient = new Menu("Client", casillas);
        Menu menuServer = new Menu("Server", casillas);
    }
